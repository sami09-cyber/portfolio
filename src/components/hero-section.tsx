...
// Importation dynamique du composant hologramme avec tous les contrôles
interface HologramHumanEnhancedProps {
    minimal?: boolean
}

const HologramHumanEnhanced = dynamic(() => import("@/components/hologram-human-enhanced"), {
    ssr: false,
    loading: () => (
        <div className="w-full h-full flex items-center justify-center bg-black/90 rounded-lg">
            <div className="text-primary animate-pulse">Chargement de l'hologramme 3D...</div>
        </div>
    ),
})

// const HologramHumanEnhanced = dynamic(({minimal}: HologramHumanEnhancedProps) => import("@/components/hologram-human-enhanced"), {
//     ssr: false,
//     loading: () => (
//         <div className="w-full h-full flex items-center justify-center bg-black/90 rounded-lg">
//             <div className="text-primary animate-pulse">Chargement de l'hologramme 3D...</div>
                ...
                <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  Votre Nom
                        ...
                        <motion.p
                            ...
                            className="text-muted-foreground max-w-lg"
                        >
                            Je crée des expériences web innovantes et futuristes qui combinent design intuitif et
                            technologies de
                            pointe.
                        </motion.p>
                    ...
                    >
                        <div className="w-full h-full relative bg-black/90 rounded-lg overflow-hidden">
                            {/* Hologramme avec tous les contrôles visibles */}
                            <HologramHumanEnhanced />

                            {/* Effet de lueur au sol - avec pointer-events-none pour ne pas bloquer les interactions */}
                            <div
                                className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-64 h-32 pointer-events-none">
                                <div className="w-full h-full bg-[#8a2be2] opacity-20 blur-3xl"/>
                            </div>
